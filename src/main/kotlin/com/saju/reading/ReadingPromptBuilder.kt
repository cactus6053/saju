...
object ReadingPromptBuilder {
    ...
    fun buildDaeun(
        ...
        append(
            ...
            출력 구조:
            1. **대운의 방향** — 순행/역행과 원국 구조가 만드는 큰 그림
            2. **인생 흐름** — 10개 대운을 의미 있는 3~4개 구간으로 묶어, 각 구간의
               십성 주제와 원국 관계(합충형파해)가 만드는 흐름을 서술
            3. **전환점** — 기운이 크게 바뀌는 대운과 그 이유
            4. **용신 대운** — 용신 오행이 들어오는 대운이 언제인지, 그 시기의 의미
