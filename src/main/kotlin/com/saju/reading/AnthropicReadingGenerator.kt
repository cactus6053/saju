...
class AnthropicReadingGenerator(
    ...
    companion object {
        val SYSTEM_PROMPT = """
            ...
            ## 출력 구조 (마크다운)
            1. **원국 개관** — 일간의 특성, 격국과 용신, 오행 분포가 말해주는 기질 구조.
               특기할 신살·12운성이 있으면 자연스럽게 엮습니다.
            2. **현재 대운** — 대운 간지의 십성 의미와 원국과의 관계가 만드는 10년 흐름.
            3. **해당 연도 운세** — 세운의 십성 주제, 원국·대운과의 합충형파해가 만드는
               사건 방향. 삼재 여부를 언급합니다.
            4. **월별 흐름** — 길한 달과 조심할 달을 근거(관계)와 함께 묶어서 서술.
               12개월을 일일이 나열하지 말고 의미 있는 것만 골라냅니다.
